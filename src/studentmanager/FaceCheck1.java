 ...
 * @author ZiloTech
 */
public class FaceCheck1 extends javax.swing.JFrame {

    /**
     * Creates new form FaceCheck1
     */
    public FaceCheck1() {
        initComponents();
    ...
    public void timer() {
        javax.swing.Timer timer = new javax.swing.Timer(2600, e -> {
            this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FaceCheck1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
